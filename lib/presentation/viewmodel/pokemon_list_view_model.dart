...
@freezed
abstract class PokemonListViewModelState with _$PokemonListViewModelState {
...
class PokemonListViewModel extends StateNotifier<PokemonListViewModelState> {
  PokemonListViewModel({required this.useCase, required this.pokedexIdRange})
    : super(
...
final pokemonListViewModelProvider = StateNotifierProvider.family
    .autoDispose<
