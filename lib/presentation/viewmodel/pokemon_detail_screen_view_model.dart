...
@freezed
abstract class PokemonDetailScreenViewModelState
...
class PokemonDetailScreenViewModel
  ...
  PokemonDetailScreenViewModel(int pokedexId, this.ref)
  ...
  Future<void> _init(int pokedexId) async {
    ...
    state = state.copyWith(pokemonDetailInfo: info);
  }
}

// provider with family auto dispose
final pokemonDetailScreenViewModelProvider =
