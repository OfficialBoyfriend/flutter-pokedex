...
@freezed
abstract class PokemonEvolutionChainData with _$PokemonEvolutionChainData {
  const factory PokemonEvolutionChainData({required ChainData chain}) =
...
@freezed
abstract class ChainData with _$ChainData {
  const factory ChainData({
    @JsonKey(name: 'evolves_to') required List<ChainData> evolvesTo,
