...
@freezed
abstract class NameUrlData with _$NameUrlData {
  const factory NameUrlData({required String name, required String url}) =
      _NameUrlData;
...
abstract class UrlData with _$UrlData {
  const factory UrlData({required String url}) = _UrlData;
...
@freezed
abstract class ImageUrlSetData with _$ImageUrlSetData {
